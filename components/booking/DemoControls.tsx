...
interface DemoControlsProps {
  ...
  /** Real navigator status — shown so the toggle's effect is clear. */
  online: boolean;
}
...
/**
 * Demo-only control strip. Lets a reviewer preview every async UI state
 * without a backend. None of this ships to real users — it's the scaffold for
 * the "обовʼязково реалізуй стани UI" requirement.
 */
