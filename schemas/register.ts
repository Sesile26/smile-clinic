 ...
 *
 * Patient.name is NOT NULL → name is required (min 2). Phone is strict UA:
 * +380 followed by exactly 9 digits. Password: min 8, at least one letter
 * and one digit — the server re-validates so the client check is purely UX.
 */
